...
export default function Navbar() {
  ...
  // Glow animation effect every 30 seconds
  useEffect(() => {
    let isMounted = true
    ...
    const startGlowAnimation = () => {
      ...
      // Schedule next glow in 30 seconds (after animation completes)
      nextGlowTimeout = setTimeout(() => {
        if (isMounted) {
          startGlowAnimation()
        }
      }, 30000) // 30 seconds between end of animation and start of next
    }
  ...
  return (
    <header className="sticky top-0 z-50 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
      {/* Glowing light effect at bottom only */}
      <div 
