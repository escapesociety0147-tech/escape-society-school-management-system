...
export default function SettingsPage() {
  const [profile, setProfile] = useLocalStorageState('esm_profile', {
    name: '',
    role: '',
    email: '',
    phone: '',
  })
  const [preferences, setPreferences] = useLocalStorageState('esm_preferences', {
    language: 'English (US)',
  ...
  const passwordUpdatedLabel = adminUser?.createdAt
  ...
  const activeModules = useMemo(() => {
    ...
    return modules.filter((count) => count > 0).length
  }, [
    students.length,
    teachers.length,
    parents.length,
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Update preferences, security settings, and notification channels.
            </p>
          </div>
