...
def client(db_session):
    """
    TestClient with get_db overridden to use the same db_session
    fixture (test database, savepoint-based rollback) as every other
    test in this project - route-level tests get the identical
    isolation guarantee as service-level tests, and never touch the
    real dev database.
    """
